...
<html lang="fr" dir="ltr">
	<head>
		<meta charset="utf-8">
		<title>Accès admin - KW Coaching</title>
		...
		<div class="content">
			<div class="container co">
				<div class="formulaire-co">
					<img src="./images/kw-coaching-logo.png" alt="">
					<form method="post">
						<h2>Se connecter</h2>
						...
						<div class="form-group text-right" style="text-align: end;">
							<input type="submit" class="btn btn-outline-primary" name="login" value="SE CONNECTER">
						</div>
					</form>
				</div>
			</div>
